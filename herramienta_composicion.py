...
def main():
    ...
    # Perfil típico de residuos agrícolas orgánicos diluidos
    feedstock_base = {
    ...
    sim1 = BioproductSimulator(feedstock_base, consorcio_espontaneo)
    ...
    sim2 = BioproductSimulator(feedstock_base, consorcio_completo)
